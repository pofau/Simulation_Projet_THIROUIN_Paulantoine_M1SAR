...
# -*- coding: utf-8 -*-
"""
Created on Tue May  9 19:04:21 2023
...
r1 = Ressort_Amortisseur(raideur=10000, c=0., l0=l0, particules = [p1, p2])
...
while u1.run:
    ...
    if u1.gameKeys[ord('q')] or u1.gameKeys[pygame.K_LEFT]:
        ...
        fh = force_const(Vecteur3D(0, 0.1, 0), [p1, p2],etat=True)
        u1.addGenerateur(fh)


    elif u1.gameKeys[ord('d')] or u1.gameKeys[pygame.K_RIGHT]:
        # Activez la force harmonique et désactivez la force constante
        fh = Force_Harmonique(Vecteur3D(0, 0.1, 0), etat=True, omega=0.05, u = [u1], particule=[p1, p2])
        u1.addGenerateur(fh)
